...
const ContactSection = () => {
  return (
    <section
      className="py-32 px-margin-mobile md:px-margin-desktop"
      id="contact"
    >
      <div className="max-w-2xl mx-auto text-center">
        <ContactHeader />
        <ContactCard socials={socialsData} />
      </div>
    </section>
  );
};
...
//         <h3 className="font-display-lg text-display-lg text-on-surface mb-8">Ready to connect?</h3>
...
//             payment systems and AI development.
//           </p>
