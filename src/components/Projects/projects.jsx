            ...
            <div className="d-flex flex-row align-items-center justify-content-center">
              <div data-aos="fade-left" data-aos-delay="200" data-aos-duration="1450" data-aos-easing="ease-out">
                <div className='d-flex align-items-center justify-content-evenly'>
                  ...
                  <img src={portfolio} alt="SNKRS Project" className='project-img' />
                  {/* <img src={} alt="SNKRS Project" className='project-img-mobile' /> */}
                  <div className="project-icon">
                    <a href="https://eacreativestudio.netlify.app/" target='_blank'><RxExternalLink /></a>
                  </div>
                </div>
              </div>
            </div>
